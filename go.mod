...
require (
	...
	github.com/hashicorp/terraform-plugin-framework v1.13.1-0.20250218211018-9ea96b95aa66
	...
	github.com/hashicorp/terraform-plugin-sdk/v2 v2.36.1-0.20250218212957-b3f09bf04c82
