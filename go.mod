...
require (
	...
	github.com/hashicorp/terraform-plugin-sdk/v2 v2.37.0-alpha.1.0.20250417093136-94a605f8d325
	github.com/hashicorp/terraform-plugin-testing v1.13.0-alpha.1.0.20250416185419-1826a6cfdd62
