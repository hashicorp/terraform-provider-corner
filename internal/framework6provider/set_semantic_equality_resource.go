...
func (m *SetSemanticEqualityResourceModel) shiftAndShorten() {
	...
	m.SetNestedAttribute = types.SetValueMust(setObjectWithIPv6, []attr.Value{
		types.ObjectValueMust(setObjectWithIPv6.AttributeTypes(), map[string]attr.Value{
			"ipv6": iptypes.NewIPv6AddressValue("2001:1:2:3:4:5:6:7"),
		}),
		types.ObjectValueMust(setObjectWithIPv6.AttributeTypes(), map[string]attr.Value{
			"ipv6": iptypes.NewIPv6AddressValue("2041:0000:140F::875B:131B"),
		}),
	})
}
