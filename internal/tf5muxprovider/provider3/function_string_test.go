		...
		Steps: []resource.TestStep{
			{
				Config: `
				output "test" {
					value = provider::tf6muxprovider::string3("str3")
				}`,
				ConfigStateChecks: []statecheck.StateCheck{
					statecheck.ExpectKnownOutputValue("test", knownvalue.StringExact("str3")),
				},
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				Config: `
				output "test" {
					value = provider::tf6muxprovider::string3(null)
				}`,
		...
		Steps: []resource.TestStep{
			{
				...
				resource "terraform_data" "test" {
					input = provider::tf6muxprovider::string3("str3")
				}
