...
func TestAccResourceRefinements(t *testing.T) {
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				// Typically, this config would return an error like:
				//
				...
				//
				// When the provider implementation preserves the unknown value refinement, this configuration can
